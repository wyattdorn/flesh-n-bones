...
function generateHeads(){
  ...
  headList.push(new Head(1, "Goblin Head", 5, "Goblin head grants the Scythe skill.",false, imageLoader.goblinHeadImg, 16));
  headList.push(new Head(2, "Orc Head", 6, "Orc head grants the Orc Smash skill.",false, imageLoader.orcHeadImg, 16));
  headList.push(new Head(3, "Mage Head", 7, "Mage head grants the Spirit Dagger skill.",false, imageLoader.mageHeadImg, 16));
  headList.push(new Head(4, "Anubis Head", 9, "Anubis head grants the Divine Aura skill.",false, imageLoader.anubisHeadImg, 16));
  ...
  headList.push(new Head(7, "Cyclops Head", 0, "Only one eye...",[0,10], imageLoader.cyclopsHeadImg, 16));
...
function generateBodies(){
  ...
  bodyList.push(new Body(1, "Old Body", 1, "Any old pile of bones can attack.",false, imageLoader.oldBodyImg, 16));
  bodyList.push(new Body(2, "Brittle Body", 3, "Brittle body grants the Heal skill.",false, imageLoader.brittleBodyImg, 16));
  bodyList.push(new Body(3, "Big Body", 2, "Big body grant the Defend skill.",false, imageLoader.bigBodyImg, 16));
...
function generateGuts(){
  ...
  gutsList.push(new Guts(3, "Healthy Guts", 8, "Healthy guts allow the owner to heal themself.",false, "yellow", 16));
