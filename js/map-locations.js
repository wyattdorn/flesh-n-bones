...
class MapLocations{
  ...
  init(){
    ...
    this.list[2] = [2, "Bleak Barrows",       220, 420, false, ["#131313", "#286355", "#111199", "#003000"], imageLoader.barrowsIcon, imageLoader.shop2Icon,   "Once the home of a world-renowned mage college, now only the dead remain."];
    ...
    this.encounterList[8] = [8, [["Aglar", 2, 1, 7, 1, 7, 7, 7, 7, 7, 7, imageLoader.kappaImg]],
                                [[/*three goblins*/], [/*some loot*/]],
                                [[/*Boss goblin*/], [/*good loot*/]]];

    this.encounterList[9] = [9, [["iiiiiii", 2, 1, 7, 1, 7, 7, 7, 7, 7, 7, imageLoader.anubisImg]],
                                [[/*three goblins*/], [/*some loot*/]],
                                [[/*Boss goblin*/], [/*good loot*/]]];
    ...
    this.lootList[0] = [0];
    this.lootList[1] = [1, [[1,2], [10,4]],            //Goblin Head
                            [[1,3], [12,4]],          //Red sludge
                            [[1,1], [3,3], [1,0]]];  //Explosive guts and purp sludge

    this.lootList[2] = [1, [[2,0], [2,1]],   //brittle body and dubious guts
                            [[1,3]],          //Red sludge
