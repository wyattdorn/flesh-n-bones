...
class MapLocations{
  ...
  init(){
    ...
    this.list[2] = [2, "Bleak Barrows",       220, 420, false, ["#131313", "#286355", "#111199", "#003000"], imageLoader.barrowsIcon,   "Once the home of a worl-renowned mage college, now only the dead remain."];
    ...
    this.list[6] = [6, "Crystal Caverns",     410, 540, false, ["#002040", "#999999", "#404070", "#000000"], imageLoader.cavernIcon,    "The crystals found underground here have a strange influence on their surroundings."];
    this.list[7] = [7, "Abandoned Hatchery",  250, 20, false, ["#006994", "#999999", "#404070", "#000000"], imageLoader.hatcheryIcon,  "This place was aboned for good reason."];
    ...
    this.list[9] = [9, "Screaming Portal",    1000, 50, false, ["#40a9ff", "#999999", "#404070", "#000000"], imageLoader.portalIcon,    "Tortured screaming eminates from this portal witout end."];
