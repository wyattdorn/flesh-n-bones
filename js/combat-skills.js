...
class Skill{
  ...
  init(){
    ...
    this.skillList[3] = [this.skillExplode,      "Explode",  7,      "level",      1.0,       "damage",   "Damage all creature on the field, including allies."];
    this.skillList[4] = [this.skillScythe,      "Scythe",   6,      "might",      2.0,       "damage",   "Damage all enemy heroes on the field."]
